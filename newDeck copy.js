...
let gameRound = function (number) {
  ...
  if (
    ...
    cl("--------------------------------------------------");
    cl("");
    cl("The game is over as all players have run out of cards!");
    cl("");
...
let finalScore = function (p1, p2, p3, p4) {
  if (p1 > p2 && p1 > p3 && p1 > p4) {
    ...
    return `Cpu-3 has the most wins with ${p4} in total!`;
  } else {
    if (p1 === 0) {
      return `No one's a winner!`;
    } else if (p1 === p3) {
      return `Player and Cpu-2 have tied with ${p1} wins each!`;
    } else if (p2 === p3) {
      return `Both Cpu-1 and Cpu-2 have tied with ${p2} wins each!`;
    } else if (p1 === p4) {
      return `Player and Cpu-3 have tied with ${p1} wins each!`;
    } else if (p2 === p4) {
      return `Both Cpu-1 and Cpu-3 have tied with ${p2} wins each!`;
    } else if (p3 === p4) {
      return `Both Cpu-2 and Cpu-3 have tied with ${p3} wins each!`;
    } else if (p1 === p2) {
      return `Player and Cpu-1 have tied with ${p1} wins each!`;
    } else {
      return `Somehow, all players tied!`;
    }
  }
};
